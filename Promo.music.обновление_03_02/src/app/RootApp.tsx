...
export default function App() {
  ...
  const [userRole, setUserRole] = useState<'artist' | 'admin' | 'radio_station'>(() => {
    const role = (localStorage.getItem('userRole') as 'artist' | 'admin' | 'radio_station') || 'artist';
    if (import.meta.env.DEV) {
  ...
  const handleLoginSuccess = (role: 'artist' | 'admin' | 'radio_station') => {
    if (import.meta.env.DEV) {
