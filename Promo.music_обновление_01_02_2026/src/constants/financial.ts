...
export const PLAYLIST_PITCHING_PRICES = {
  yandex: 25000,   // Яндекс.Музыка
  vk: 20000,       // VK Музыка
  spotify: 35000,  // Spotify
  all: 60000,      // Пакет Single Boost (все 3)
  ep: 140000,      // EP Campaign (3 трека на все)
  album: 300000,   // Album Domination (8+ треков)
};
...
export const TESTING_PRICES = {
  ...
  tech_quick: 5000,            // Быстрая проверка
  tech_standard: 12000,        // Стандартная
  tech_comprehensive: 25000,   // Комплексная
  tech_expert: 60000,          // Эксперт
  
  // Фокус-группы
  focus_mini: 15000,           // Мини (50 чел)
  focus_standard: 35000,       // Стандарт (150)
  focus_premium: 90000,        // Премиум (500)
  
  // Коммерческий анализ
  commercial_express: 8000,    // Экспресс
  commercial_standard: 20000,  // Стандартный
  commercial_expert: 60000,    // Эксперт
  
  // A/B тестирование
  ab_2_versions: 12000,        // 2 версии (50 чел)
  ab_3_versions: 35000,        // 3 версии (150)
  ab_4_versions: 85000,        // 4 версии (300)
  
  // Стриминг-потенциал
  streaming_basic: 15000,      // Базовый
  streaming_premium: 28000,    // Премиум
  streaming_pro: 50000,        // PRO
  
  // Креативный фидбек
  feedback_producer: 10000,    // Продюсер (1 трек)
  feedback_team: 35000,        // Вся команда (1 трек)
};
