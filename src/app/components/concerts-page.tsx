...
export function ConcertsPage({ userCoins, onCoinsUpdate }: ConcertsPageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-2">Мои концерты</h1>
          <p className="text-gray-300 text-base md:text-lg">Управляйте предстоящими событиями</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
          ...
          <motion.button
            ...
            className="px-6 py-3 rounded-xl bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white font-semibold transition-all duration-300 shadow-lg shadow-purple-500/15 flex items-center justify-center gap-2"
          >
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="p-4 md:p-5 rounded-2xl backdrop-blur-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300"
        >
          <div className="text-gray-400 text-xs md:text-sm mb-2">Всего концертов</div>
        ...
        <motion.div
          ...
          className="p-4 md:p-5 rounded-2xl backdrop-blur-xl bg-green-500/10 border border-green-400/30 hover:bg-green-500/20 transition-all duration-300"
        >
          <div className="text-green-400 text-xs md:text-sm mb-2">Одобрено</div>
          <div className="text-2xl md:text-3xl font-bold text-white">{stats.approved}</div>
        </motion.div>
        ...
        <motion.div
          ...
          className="p-4 md:p-5 rounded-2xl backdrop-blur-xl bg-yellow-500/10 border border-yellow-400/30 hover:bg-yellow-500/20 transition-all duration-300"
        >
          <div className="text-yellow-400 text-xs md:text-sm mb-2">На модерации</div>
          <div className="text-2xl md:text-3xl font-bold text-white">{stats.pending}</div>
        </motion.div>
        ...
        <motion.div
          ...
          className="p-4 md:p-5 rounded-2xl backdrop-blur-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300"
        >
          <div className="text-gray-400 text-xs md:text-sm mb-2">Просмотры</div>
          <div className="text-2xl md:text-3xl font-bold text-white">{stats.totalViews.toLocaleString()}</div>
        </motion.div>
        ...
        <motion.div
          ...
          className="p-4 md:p-5 rounded-2xl backdrop-blur-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300"
        >
          <div className="text-gray-400 text-xs md:text-sm mb-2">Клики на билеты</div>
          <div className="text-2xl md:text-3xl font-bold text-white">{stats.totalClicks.toLocaleString()}</div>
        </motion.div>
      </div>
      ...
      >
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-purple-400/50 transition-all duration-300"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="w-full sm:w-auto px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white focus:outline-none focus:border-purple-400/50 transition-all duration-300 cursor-pointer"
          >
