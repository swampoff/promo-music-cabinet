...
export function NewsPage({ userCoins, onCoinsUpdate, onNewsUpdate }: NewsPageProps) {
  ...
  // Обновление новостей в родительском компоненте
    ...
    <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 space-y-4 sm:space-y-5 lg:space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-2 sm:gap-3 md:gap-4">
        ...
        >
          ...
          <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white">{stats.totalLikes.toLocaleString()}</div>
        </motion.div>
        ...
        >
          ...
          <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white">{stats.totalComments.toLocaleString()}</div>
        </motion.div>
                  ...
                  {news.status === 'approved' && (
                    <div className="flex items-center gap-2 sm:gap-3 md:gap-4 text-xs sm:text-sm text-gray-400 pt-2 border-t border-white/10">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-[10px] sm:text-xs md:text-sm">{news.views.toLocaleString()}</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <Heart className="w-3 h-3 sm:w-4 sm:h-4" />
                        <span className="text-[10px] sm:text-xs md:text-sm">{news.likes.toLocaleString()}</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <MessageSquare className="w-3 h-3 sm:w-4 sm:h-4" />
                        <span className="text-[10px] sm:text-xs md:text-sm">{news.comments.toLocaleString()}</span>
                      </div>
                    </div>
                  )}
                ...
                <div className="p-3 sm:p-4 md:p-6 lg:p-8">
                  ...
                  <div className="flex flex-wrap items-center gap-3 sm:gap-4 md:gap-6 p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl bg-white/5 border border-white/10">
                    <div className="flex items-center gap-1.5 sm:gap-2 text-gray-300">
                      ...
                      <span className="font-semibold text-sm sm:text-base">{selectedNews.views.toLocaleString()}</span>
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2 text-gray-300">
                      ...
                      <span className="font-semibold text-sm sm:text-base">{selectedNews.likes.toLocaleString()}</span>
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2 text-gray-300">
                      ...
                      <span className="font-semibold text-sm sm:text-base">{selectedNews.comments.toLocaleString()}</span>
            ...
            >
              ...
              <div className="space-y-2 sm:space-y-3 md:space-y-4 mb-3 sm:mb-4 md:mb-6">
                ...
                <div className="flex items-center justify-between p-2.5 sm:p-3 md:p-4 rounded-lg sm:rounded-xl bg-white/5">
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <Coins className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-yellow-400" />
                    <span className="text-white font-bold text-base sm:text-lg md:text-xl">{userCoins.toLocaleString()}</span>
                  </div>
                </div>
