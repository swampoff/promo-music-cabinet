    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white p-6">
      ...
      >
        ...
        <ul className="space-y-2 text-sm text-gray-300">
          <li>• <strong>Фаза 1 (текущая)</strong>: Подписки + промо-инструменты</li>
          <li>• <strong>Фаза 2 (Q3 2026)</strong>: Запуск Promo Coins (внутренняя валюта)</li>
          <li>• <strong>Фаза 3 (Q1 2027)</strong>: Revenue Share с заведениями (пассивный доход!)</li>
