import { X, Check, Clock, Radio, Music as MusicIcon, Building2, Users, Send, AlertCircle, Sparkles, ExternalLink, Coins, Instagram, Youtube, Globe, TrendingUp, FileText, Copyright, User, Disc, Sliders, Headphones, Mic, Settings } from 'lucide-react';
...
export function TrackPitchingModal({ track, isOpen, onClose, userCoins, onCoinsUpdate }: TrackPitchingModalProps) {
  ...
  const categories = [
    { id: 'streaming' as PitchingCategory, label: 'Стриминги', icon: MusicIcon, count: 6 },
    { id: 'social' as PitchingCategory, label: 'Соцсети', icon: Users, count: 5 },
    { id: 'venues' as PitchingCategory, label: 'Площадки', icon: Building2, count: 4 },
              ...
              <div className="md:col-span-2 p-4 rounded-xl bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-400/30">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                  ...
                  {track.credits.arranger && (
                    <div className="flex items-center gap-2">
                      <MusicIcon className="w-4 h-4 text-yellow-400" />
                      <div>
