import { X, Check, Clock, AlertCircle, Sparkles, Coins, Play, TrendingUp, Users, Globe, Instagram, Music as MusicIcon, Radio, Eye, Calendar, Tag, Film, User, Clapperboard, Lightbulb, Pen, Sparkle, Camera, Scissors, Briefcase } from 'lucide-react';
