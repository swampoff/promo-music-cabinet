import { DollarSign, Users, Gift, TrendingUp, Calendar, Download, Settings, Eye, Heart, MessageSquare, Filter, Search, ArrowUpRight, ArrowDownRight, Wallet, CreditCard, ChevronDown, X, Copy, Check, ExternalLink, Info, Bell, BellOff, Link as LinkIcon, Share2, MessageCircle } from 'lucide-react';
...
export function DonationsPage({ userCoins, onCoinsUpdate, onReplyToDonator }: DonationsPageProps) {
      ...
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 w-full sm:w-auto">
            ...
            >
              <LinkIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 flex-shrink-0" />
                  ...
                  {!donation.isAnonymous && onReplyToDonator && (
                    <div className="mt-2 sm:mt-3">
                      <motion.button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 font-medium transition-all duration-300 flex items-center gap-2 text-xs"
                      >
